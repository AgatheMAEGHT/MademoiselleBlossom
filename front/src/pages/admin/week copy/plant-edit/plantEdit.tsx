...
import { article, newArticleDB, colorDB, toneDB, select, newColorDB, newToneDB, speciesDB, newSpeciesDB, editArticleOptions, selectColor, alertStatus, articleType } from '../../../../components/types';

import '../../catalog-edit/catalogEdit.css';

function PlantEditAdmin() {
    ...
    return (
        <div className='admin-page page'>
            <h1 className='admin-page-title'>Admin - Modifier une plante</h1>

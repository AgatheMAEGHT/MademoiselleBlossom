...
function FeteDesGrandsMeres() {
    // Src image in public folder
    return (
        <div id="inspiration">
            <MetaData title="Fête des grand-mères" url="/Fête_des_grand-mères" />
            <h1 className='page-title'>Fête des Grand-Mères</h1>
...
export default FeteDesGrandsMeres;